...
class MiniCPMAttention(nn.Module):
    ...
    def __init__(self, hidden_size: int, num_heads: int, num_kv_heads: int, rotary_emb: nn.Module) -> None:
        super().__init__()
...
class MiniCPMDecoderLayer(nn.Module):
    ...
    def __init__(self, config, rotary_emb: nn.Module) -> None:
        ...
        self.mlp = MiniCPMMLP(hidden_size=config.hidden_size, intermediate_size=config.intermediate_size)
